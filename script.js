...
const presets = [
  {
    ...
    amLink: "https://alightcreative.com/am/share/u/jwqTGrplNNXeATKCArnaBhLzn0G2/p/nKRmvoCe5j-9abe0516a36b5872",
  },
];
...
function renderDownloadCards() {
  ...
  presets.forEach((preset, index) => {
    ...
    card.innerHTML = `
      <div class="card-icon" style="background: ${preset.color};">${preset.icon}</div>
      <div class="card-body">
        <h3>${preset.name}</h3>
        <p>${preset.desc}</p>
        <div class="card-meta">
        ...
        ${preset.amLink ? `<a class="btn-am-link" href="${preset.amLink}" target="_blank" rel="noopener noreferrer"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>Preset 5MB</a>` : ""}
      </div>
